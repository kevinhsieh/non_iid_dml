...
void CuDNNConvolutionLayer<Dtype>::Forward_gpu(
  ...
  /* XXX: synchronize with our current stream before using the new streams */
...
//#endif
    ...
    /* XXX: synchronize the cuDNN streams */
    for (int g = 0; g < this->group_; g++) {
...
void CuDNNConvolutionLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
  ...
  /* XXX: synchronize with our current stream before using these new streams */
  CUDA_CHECK(cudaStreamSynchronize(Caffe::cuda_stream()));
